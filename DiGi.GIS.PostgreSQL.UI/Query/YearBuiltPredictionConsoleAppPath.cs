...
namespace DiGi.GIS.PostgreSQL.UI
{
    public static partial class Query
    {
        ...
        /// <para>Three candidates in order: the path given, then beside this application's own output, then the runner's build output in a workspace checkout. The last is what makes the task runnable from a development machine without deploying anything.</para>
